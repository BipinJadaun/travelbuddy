...
@ControllerAdvice
@Controller
public class BookMyCabExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity handleAlreadyExistException(ResourceAlreadyExistException ex, WebRequest request){
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(), request.getDescription(false));
